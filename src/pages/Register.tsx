            ...
            <div className="p-6 bg-white/5 rounded-2xl border border-white/5 flex items-start gap-4">
              ...
              <div>
                <p className="text-white/60 text-xs font-body leading-relaxed">
                  By proceeding, you agree to the tournament regulations and the entry fee of <span className="text-white font-bold">Rs. {event?.entryFee || 900} + Service Charge</span>. Registration is final once payment is confirmed.
                </p>
              </div>
            </div>
